...
class ProfileManager(object):
    def __init__(self):
        ...
        self.profiles = resources.getSimpleModeProfiles(profile.getMachineSetting('machine_type'))
...
class simpleModePanel(wx.Panel):
    ...
    def __init__(self, parent, callback):
        ...
        for nozzle_size in self._profile_manager.getNozzleSizes():
            ...
            button = wx.RadioButton(printNozzlePanel, -1, name,
                                    style=wx.RB_GROUP if len(self._print_nozzle_options) == 0 else 0)
        ...
        for name in self._profile_manager.getMaterialNames():
            button = wx.RadioButton(printMaterialPanel, -1, name,
        ...
        for name in self._profile_manager.getProfileNames():
            button = wx.RadioButton(printTypePanel, -1, name,
        ...
        self.platform_adhesion_combo = wx.ComboBox(self.platform_adhesion_panel, -1, '', choices=[_("None"), _("Brim")],
